...
class Sparse3D:
    ...
    def __init__(self):
        ...
        self._minCoords = (0,0,0,0)
        self._maxCoords = (0,0,0,0)
    ...
    def getValue( self, coords ):
        ...
        #print( coords, self._values.get(coords, 0) )
    ...
    def dumpSpaceValues( self ):
        for w in range(self._minCoords[3],self._maxCoords[3]+1):
    ...
    def surroundingValue( self, coords ):
        ...
        result = reduce(
            ...
            product( 
                ...
                range(coords[3]-1,coords[3]+2),
            ),
            0
        )
        #print( coords, result-self.getValue(coords))
    ...
    def runOneCycle(self):
        ...
        for oneCoord in product(
                                ...
                                range(self._minCoords[3]-1,self._maxCoords[3]+2),
                            ):
    ...
    def totalCells( self ):
        return reduce(
            ...
            product( 
                ...
                range(self._minCoords[3],self._maxCoords[3]+1),
            ),
            0
        )
...
for oneLine, y in zip(inputText,range(len(inputText))):
    ...
    for oneChar, x in zip( oneLine, range(len(oneLine))):
        ...
        if oneChar == "#":
            space.setValue( (x, y, 0, 0), 1 )
        else:
            space.setValue( (x, y, 0, 0), 0 )
...
print(space.surroundingValue((0,0,-1,-1)))
